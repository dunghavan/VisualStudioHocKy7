    ...
    public class KhachHangDAO: DBConnection
    {
        ...
        public bool Insert_KhachHang(string _maKH, string _hoTen, string _diaChi, string _soDT, string _ghiChu, bool _isActive)
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@hoTen", SqlDbType.VarChar, 10)).Value = _hoTen;
                cmd.Parameters.Add(new SqlParameter("@diaChi", SqlDbType.VarChar, 50)).Value = _diaChi;
                cmd.Parameters.Add(new SqlParameter("@soDT", SqlDbType.VarChar, 15)).Value = _soDT;
                cmd.Parameters.Add(new SqlParameter("@ghiChu", SqlDbType.VarChar, 100)).Value = _ghiChu;
                cmd.Parameters.Add(new SqlParameter("@isActive", SqlDbType.VarChar, 100)).Value = _isActive;
