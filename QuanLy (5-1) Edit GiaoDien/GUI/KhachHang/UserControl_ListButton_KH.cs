    ...
    public partial class UserControl_ListButton_KH : UserControl
    {
        ...
        private void btn_Xoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DialogResult dialogResult = XtraMessageBox.Show("Bạn có muốn vô hiệu hóa khách hàng?", "Xác nhận!", MessageBoxButtons.YesNo);
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    if (deleted)
                    {
                        ...
                        UserControl_QLKH.Instance.label_notification.Text = "Đã vô hiệu hóa khách hàng!";
                    }
                    else
