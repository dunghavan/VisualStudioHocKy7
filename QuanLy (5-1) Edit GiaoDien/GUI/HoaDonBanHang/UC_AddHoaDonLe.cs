    ...
    public partial class UC_AddHoaDonLe : UserControl
    {
        ...
        public void ToggleUI(bool isAdd = false)
        {
            if (isAdd)
            {
                ...
                label_tongthanhtoan.Visible = false;
                label_DMSP.Visible = false;
                label_CTHD.Visible = false;
            ...
            else
            {
                ...
                btn_HuyHD.Visible = true;
                label_tongthanhtoan.Visible = true;
                label_DMSP.Visible = true;
                label_CTHD.Visible = true;
        ...
        {
            hdBUS.Update_TongTienHD(txt_maHD2.Text, int.Parse(txtTongthanhtoan.Text));
            Form parentForm = this.FindForm();
            ((MainForm)parentForm).mainPanel.Controls.Add(UC_ListHoaDon.Instance);
            UC_ListHoaDon.Instance.BringToFront();
