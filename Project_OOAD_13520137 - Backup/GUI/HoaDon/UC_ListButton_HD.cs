...
namespace GUI
{
    public partial class UC_ListButton_HD : UserControl
    {
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            if (!MainForm.mainPanel.Controls.Contains(UC_AddHoaDonLe.Instance))
            {
                MainForm.mainPanel.Controls.Add(UC_AddHoaDonLe.Instance);
            }
        ...
        {
            Form parentForm = this.FindForm();
            if (!MainForm.mainPanel.Controls.Contains(UC_SuaHoaDonLe.Instance))
                MainForm.mainPanel.Controls.Add(UC_SuaHoaDonLe.Instance);
